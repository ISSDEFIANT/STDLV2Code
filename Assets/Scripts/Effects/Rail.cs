...
public class Rail : MonoBehaviour
{
    ...
    public Vector3 PositionOnRail(int seg, float ratio, STMethods.RailPlaymode PlayMode)
    {
        switch (PlayMode)
        {
            default:
            case STMethods.RailPlaymode.Linear:
                return LinearPosition(seg, ratio);
            case STMethods.RailPlaymode.Catmull:
    ...
    public Quaternion Orientation(int seg, float ratio)
    {
        ...
        Quaternion p2 = nodes[seg + 1].rotation;
